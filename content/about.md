...
whatSetsMeApart:
  ...
  - title: "Comfortable Environment"
    description: "Clients say I make them feel relaxed and confident in front of the camera. 137+ five-star Google reviews back that up."
...
BRAND COLORS:
  • CMQ Blue (Primary):        #5577a5  ← Headings, accents, buttons
  • CMQ Gray Dark:              #575757  ← Dark backgrounds, body text
  • CMQ Gray Darker:            #383838  ← Font color on light backgrounds
  • CMQ White:                  #FFFFFF  ← White backgrounds and text
  • CMQ Gray Light:             #D0D0D0  ← Light gray backgrounds
  • Light Gray Background:      #F1F1F1  ← Section backgrounds

TYPOGRAPHY:

  H1 (Hero Headings):
    • Font: Raleway
    • Desktop: 60-72px (text-6xl to text-7xl)
    • Mobile: 36-48px (text-4xl to text-5xl)
    • Weight: Mixed bold (900) / light (300)
    • Color: White on overlays, Blue (#5577a5) on white

  H2 (Section Headings):
    • Font: Raleway
    • Size: text-3xl lg:text-4xl (default) | text-2xl lg:text-3xl (small)
    • Weight: Mixed bold (700) / normal (400)
    • Color: Blue (#5577a5)
    • Alignment: Centered
