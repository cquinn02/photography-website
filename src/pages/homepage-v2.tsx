...
export default function HomepageV2() {
  return (
    <Layout
      title="Homepage v2 Demo | CMQ Headshots"
      description="Internal demo of homepage redesign with consolidated keyword sections."
    >
      {/* DEMO PAGE — noindex so Google does not crawl or index this preview */}
      <Head>
      ...
      <section className="relative w-full">
        <picture>
          <source media="(max-width: 767px)" srcSet="https://images.cmqheadshots.com/images/website%20media/cmq-pro-phoenix-headshots-hero2-mobile-640.webp" />
          <source media="(max-width: 1023px)" srcSet="https://images.cmqheadshots.com/images/website%20media/cmq-pro-phoenix-headshots-hero2-mobile-828.webp" />
          <source media="(max-width: 1599px)" srcSet="https://images.cmqheadshots.com/images/website%20media/cmq-pro-phoenix-headshots-hero2-desktop-1400.webp" />
          <source media="(max-width: 2559px)" srcSet="https://images.cmqheadshots.com/images/website%20media/cmq-pro-phoenix-headshots-hero2-desktop-1920.webp" />
          <img
