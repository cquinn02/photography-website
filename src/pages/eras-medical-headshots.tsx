      ...
      <section className="py-20" style={{ backgroundColor: '#5577a5' }}>
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="font-raleway text-xl mb-8 max-w-2xl mx-auto" style={{ color: 'white', fontWeight: '400', lineHeight: '1.6' }}>
            My studio is in North Phoenix with easy access from the 101 and I-17. The session takes 20 minutes. With 14 years of experience and 139+ five-star Google reviews, I make the process quick and comfortable. Do not wait until August when every med student in Phoenix is trying to book the same week.
          </p>
          <a
            href="https://cmqheadshots.as.me/ERASHeadshot"
            target="_blank"
