        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="font-raleway text-lg md:text-xl mb-6 leading-relaxed text-black max-w-3xl mx-auto">
              Your LinkedIn profile photo works for you 24/7, 365 days a year. It is often the first impression you make on recruiters, clients, and business connections. I have been shooting LinkedIn headshots in Phoenix for over 14 years with 135+ five-star Google reviews.
            </p>
      ...
      <section className="py-20" style={{ backgroundColor: '#5577a5' }}>
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="font-raleway text-xl mb-8 max-w-3xl mx-auto" style={{ color: 'white', fontWeight: '400', lineHeight: '1.7' }}>
            If you are searching for LinkedIn headshots near me in the Phoenix area, my studio is in North Phoenix with easy access from the 101 and I-17. The LinkedIn Express session takes 20 minutes, so you can knock it out on a lunch break. With 135+ five-star Google reviews and <Link href="/about" className="underline hover:no-underline" style={{ color: '#ffffff' }}>over 14 years of experience</Link>, I make the process quick and comfortable.
          </p>
