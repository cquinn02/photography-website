  ...
  return (
    ...
    >
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <p className="font-raleway text-xl font-normal" style={{
              ...
              of experience and 136+ five-star Google reviews. I photograph business professionals,
      ...
      <KWSection
        ...
        description="A headshot photographer Phoenix professionals book again and again comes down to experience, reviews, and results. I have 136+ five-star Google reviews and 14 years behind the camera. Headshots are not a side gig for me. This is all I do, every day."
      ...
      <KWSection
        ...
        description={`"Best headshot photographer Phoenix" is more than a search term. It's a standard built on experience, consistency, and specialization. For over 14 years, CMQ Headshots has focused exclusively on professional headshots, earning 136+ five-star Google reviews from clients across the Phoenix area.`}
      ...
      <KWSection
        ...
        description="Professional headshots Phoenix, AZ from a studio that does only headshots. Fourteen years of experience, 136+ five-star Google reviews, and sessions that are never rushed."
