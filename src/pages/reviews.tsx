...
export default function Reviews({ reviews }: ReviewsPageProps) {
  ...
  return (
    <Layout
      title="137+ Five-Star Phoenix Reviews | CMQ Headshots"
      description="Why do Phoenix professionals choose CMQ Headshots? Read 137+ 5-star Google reviews from real clients and find out."
