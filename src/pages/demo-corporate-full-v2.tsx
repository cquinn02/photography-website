...
export default function DemoCorporateFullV2() {
  const corporateFAQs = [
    {
      id: 1,
  ...
  return (
    <Layout
      title="DEMO V2 FULL — Corporate Split Hero | CMQ Headshots"
    ...
    >
      ...
      {/* Split Hero (DEMO) */}
      <SplitHeroDemo imageLeft={false} panelBg="white" centered={true} quoteHref="#request-quote" />
