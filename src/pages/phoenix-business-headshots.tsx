  ...
  return (
    <>
      <Layout
        ...
        description="Professional business and executive headshots in Phoenix, AZ for company bios, websites, and personal branding. Individual studio sessions, 137+ 5-star reviews."
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
                ...
                <div ref={pricingRef} className="text-center max-w-md">
                  <div className="font-raleway mb-10" style={{ color: '#383838', lineHeight: '1.1' }}>
                    ...
                    <div className="text-2xl md:text-3xl" style={{ color: '#5577a5', fontWeight: '500', lineHeight: '1.3' }}>
                      Comfortable, Easy Headshots<br />You&apos;re Going to Love
                    </div>
                  </div>
            ...
            <AcuityBookingFacade
              ...
              title="Schedule Business Headshot Session"
            />
      ...
      <ThreeReviewSection
        title="137+ Five-Star Google Reviews"
        reviews={[
          {
