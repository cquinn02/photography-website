  ...
  return (
    <>
      <Layout
        ...
        description="Professional actor headshots in Phoenix, AZ. Theatrical, commercial, and character headshots. 14+ years experience, 135+ five-star reviews."
        ...
        <div className="relative py-6 lg:py-10" style={{
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="font-raleway text-lg lg:text-xl font-normal mt-6 max-w-3xl lg:max-w-5xl mx-auto" style={{ color: 'white', fontWeight: '400', letterSpacing: '0.03em', lineHeight: '1.6' }}>
              Actor headshots in Phoenix, AZ, shot every Saturday with up to 4 hours of studio time. Theatrical, commercial, character, and comedy, whatever you are looking for. 14+ years, 135+ five-star reviews, and you only buy the images you want/need to further your acting career.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <p className="font-raleway text-xl text-center font-normal" style={{ color: '#000000', fontWeight: '400', letterSpacing: '0.03em', lineHeight: '1.6' }}>
                Every Saturday is reserved for actors and models. You get up to 4 hours of studio time so we can really dig into your characters and get creative. With <Link href="/about" className="underline hover:no-underline" style={{ color: '#5577a5' }}>14+ years of experience</Link> and 135+ five-star Google reviews, I know what casting directors want to see. My pricing is straightforward: $250 session fee, then $100 per image you choose. No minimum purchase, no packages, no pressure.
              </p>
