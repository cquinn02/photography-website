      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="bg-gray-50 border-b">
          <div className="container mx-auto px-4 py-4">
            <nav className="text-sm">
              ...
              <span className="mx-2 text-black">›</span>
              <span className="text-black">How To Prep for Your Best Professional Headshot</span>
            </nav>
          </div>
        </div>
        ...
        <article className="container mx-auto px-4 py-16 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-xl mb-8 leading-relaxed" style={{ color: '#000000' }}>Create an easier experience during your photo session by taking some time to plan for the following:</p>
            ...
            <p className="text-xl mb-8 leading-relaxed" style={{ color: '#000000' }}>Below, we take a look at how planning for each of these can help your session go smoothly and help us to create the best results together.</p>

            <h2 className="font-raleway text-3xl lg:text-4xl font-medium mb-6 text-center uppercase" style={{ color: '#5577a5' }}>Scheduling</h2>
            <p className="text-xl mb-8 leading-relaxed" style={{ color: '#000000' }}>The day you choose for your headshot session can make a big difference to the results of your pictures. To give yourself the best chance of presenting your best, avoid booking your session on days when you have:</p>
