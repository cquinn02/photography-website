      ...
      <div className="min-h-screen bg-white">
        ...
        <article className="container mx-auto px-4 py-16 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-xl mb-8 leading-relaxed" style={{ color: '#383838' }}>Create an easier experience during your photo session by taking some time to plan for the following:</p>
