      ...
      <div className="min-h-screen bg-white">
        ...
        <article className="container mx-auto px-4 py-16 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="font-raleway text-3xl lg:text-4xl font-bold mb-6 text-center uppercase" style={{ color: '#5a81b9' }}>Why Preparation is So Important for Your Headshots</h2>
            <p className="mb-6">
            ...
            <h2 className="font-raleway text-3xl lg:text-4xl font-bold mb-6 text-center uppercase" style={{ color: '#5a81b9' }}>Scheduling</h2>
            ...
            <h2 className="font-raleway text-3xl lg:text-4xl font-bold mb-6 text-center uppercase" style={{ color: '#5a81b9' }}>Rest</h2>
            <p className="mb-6">
            ...
            <h2 className="font-raleway text-3xl lg:text-4xl font-bold mb-6 text-center uppercase" style={{ color: '#5a81b9' }}>Shave Prior to Your Shoot, But Not Immediately Before</h2>
            <p className="mb-6">
            ...
            <h2 className="font-raleway text-3xl lg:text-4xl font-bold mb-6 text-center uppercase" style={{ color: '#5a81b9' }}>Hydration</h2>
            <p className="mb-6">
            ...
            <h2 className="font-raleway text-3xl lg:text-4xl font-bold mb-6 text-center uppercase" style={{ color: '#5a81b9' }}>Choose Your Clothing in Advance</h2>
            <p className="mb-6">
            ...
            <h2 className="font-raleway text-3xl lg:text-4xl font-bold mb-6 text-center uppercase" style={{ color: '#5a81b9' }}>Hair and Makeup</h2>
            <p className="mb-6">
            ...
            <h2 className="font-raleway text-3xl lg:text-4xl font-bold mb-6 text-center uppercase" style={{ color: '#5a81b9' }}>Finally, Relax</h2>
            <p className="mb-6">
            ...
            <h2 className="font-raleway text-3xl lg:text-4xl font-bold mb-6 text-center uppercase" style={{ color: '#5a81b9' }}>How are CMQ Headshots Different for professional headshots in Phoenix?</h2>
            <p className="mb-8">
            ...
            <h2 className="font-raleway text-3xl lg:text-4xl font-bold mb-6 text-center uppercase" style={{ color: '#5a81b9' }}>FAQs</h2>
