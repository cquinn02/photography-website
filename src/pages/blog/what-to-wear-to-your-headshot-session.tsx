      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="bg-gray-50 border-b">
          <div className="container mx-auto px-4 py-4">
            <nav className="text-sm">
              ...
              <span className="mx-2 text-black">›</span>
              <span className="text-black">What to Wear to Your Headshot Session</span>
            </nav>
          </div>
        </div>
        ...
        <article className="container mx-auto px-4 py-16 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-xl mb-8 leading-relaxed" style={{ color: '#000000' }}>Choose colors that photograph beautifully and complement your skin tone:</p>
            ...
            <p className="text-xl mb-8 leading-relaxed" style={{ color: '#000000' }}>The right fabric and fit can make a significant difference in your headshots:</p>
            ...
            <p className="text-xl mb-8 leading-relaxed" style={{ color: '#000000' }}>The right neckline can enhance your appearance and complement your face shape:</p>
            ...
            <p className="text-xl mb-8 leading-relaxed" style={{ color: '#000000' }}>Keep accessories minimal to maintain focus on your face:</p>
            <ul className="list-disc pl-6 mb-6 space-y-2 text-xl" style={{ color: '#000000' }}>
            ...
            <p className="text-xl mb-8 leading-relaxed" style={{ color: '#000000' }}>Some accessories can enhance your professional appearance:</p>
            <ul className="list-disc pl-6 mb-6 space-y-2 text-xl" style={{ color: '#000000' }}>
            ...
            <p className="text-xl mb-8 leading-relaxed" style={{ color: '#000000' }}>Come prepared with multiple options:</p>
            <ul className="list-disc pl-6 mb-6 space-y-2 text-xl" style={{ color: '#000000' }}>
