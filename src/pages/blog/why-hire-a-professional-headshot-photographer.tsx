      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="bg-gray-50 border-b">
          <div className="container mx-auto px-4 py-4">
            <nav className="text-sm">
              ...
              <span className="mx-2 text-black">›</span>
              <span className="text-black">Why hire a professional headshot photographer</span>
            </nav>
          </div>
        </div>
        ...
        <article className="container mx-auto px-4 py-16 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="font-raleway text-xl mb-8 leading-relaxed" style={{ color: '#000000' }}>Here are the top reasons to hire a professional photographer:</p>
          ...
          <div className="bg-gray-50 rounded-lg p-8 mt-12">
            ...
            <p className="text-xl mb-6 leading-relaxed text-center" style={{ color: '#000000' }}>
