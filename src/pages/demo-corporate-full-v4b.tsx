...
export default function DemoCorporateFullV4B() {
  const corporateFAQs = [
    {
      id: 1,
  ...
  return (
    <Layout
      title="DEMO V4B FULL — Corporate Split Hero | CMQ Headshots"
    ...
    >
      ...
      {/* Split Hero (DEMO) */}
      <SplitHeroDemo layout="half" imageLeft={false} panelBg="dark-grey" centered={true} quoteHref="#request-quote" />
