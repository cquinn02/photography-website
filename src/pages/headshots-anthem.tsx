...
import { Award, Heart, Shield, MapPin, Briefcase, Camera, Users, Home } from 'lucide-react'
...
export default function HeadshotsAnthem() {
  return (
    <Layout
      title="Professional Headshots Anthem AZ | CMQ Headshots"
      description="Professional headshot photographer IN Anthem AZ. Your local headshot studio! Business, actor, modeling & corporate headshots. On-location available. Book today!"
      canonical="https://www.cmqheadshots.com/headshots-anthem"
      ogUrl="https://www.cmqheadshots.com/headshots-anthem"
    >
      ...
      <FAQSchema faqs={[
        { question: "Are you really located in Anthem?", answer: "Yes! My professional headshot studio is right here in Anthem. I'm your true local headshot photographer - no driving to Phoenix, Scottsdale, or anywhere else. Just a quick trip within our community." },
        { question: "What types of headshots do you offer in Anthem?", answer: "I offer a full range of headshot services: business and LinkedIn headshots, actor and theatrical headshots, modeling headshots, corporate team photography, and personal branding sessions. Whatever your professional needs, I can help." },
        { question: "Do you offer on-location headshots in Anthem?", answer: "Yes! I can come to your Anthem home or business for headshot sessions. This is perfect for busy professionals, corporate teams, or anyone who prefers the comfort of their own space." },
        ...
        { question: "Can you do corporate team headshots in Anthem?", answer: "Yes! I offer on-location corporate photography where I bring my studio setup to your Anthem office. I can also schedule your team members at my studio for consistent, professional results." }
      ]} />
      ...
      <section className="relative w-full">
        <picture>
          ...
          <img
            ...
            alt="Professional Headshots Anthem Arizona"
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="font-raleway text-lg md:text-xl mb-6 leading-relaxed text-gray-700">
              Finally, a professional headshot studio right here in Anthem! No more driving 30-45 minutes to Phoenix or Scottsdale for quality headshots. I&apos;m your neighbor, and my professional studio is right in our community. I create stunning headshots for Anthem&apos;s professionals, entrepreneurs, and business owners - with the convenience you deserve.
            </p>
      ...
      {/* Local Anthem Section */}
      <section className="section" style={{ backgroundColor: '#F1F1F1', paddingTop: '60px', paddingBottom: '60px' }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              <MapPin className="h-8 w-8 text-cmq-blue" />
              <h2 className="font-raleway text-3xl lg:text-4xl text-cmq-blue">
                <span className="font-bold">LOCATED RIGHT HERE</span> <span className="font-light">IN ANTHEM</span>
              </h2>
            </div>
            <p className="font-raleway text-xl text-cmq-gray-dark max-w-3xl mx-auto">
              I&apos;m not in Phoenix. I&apos;m not in Scottsdale. I&apos;m right here in Anthem - your neighbor and your local professional headshot photographer. Support local and skip the long drive!
            </p>
          </div>
        </div>
      </section>

      {/* Professional Headshots Anthem Section */}
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">ANTHEM&apos;S OWN</span> <span className="font-normal">HEADSHOT STUDIO</span>
          </>
        }
        description="For years, Anthem professionals had to drive to Phoenix or Scottsdale for quality headshots. Not anymore! My professional studio is right here in our community. I understand Anthem's unique mix of entrepreneurs, remote workers, realtors, and professionals who call this amazing community home. Get the professional headshots you need - without leaving the neighborhood."
        ctaText="GET PRICING"
        ...
        imageAlt="Professional headshots Anthem"
      ...
      {/* Anthem Business Section */}
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">BUSINESS HEADSHOTS</span> <span className="font-normal">ANTHEM</span>
          </>
        }
        description="Anthem is home to thousands of professionals - many working remotely, running businesses, or commuting to offices across the Valley. Wherever your career takes you, professional headshots are essential for LinkedIn, company websites, and personal branding. As your local photographer, I offer the convenience of a neighborhood studio with the quality you'd expect from a Phoenix professional."
        ...
        imageAlt="Business headshots Anthem Arizona"
      ...
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">ACTOR HEADSHOTS</span> <span className="font-normal">ANTHEM</span>
          </>
        }
        ...
        imageAlt="Actor headshots Anthem Arizona"
        backgroundColor="#282725"
        textColor="white"
        titleColor="white"
        reverseColumns={false}
      ...
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">MODELING HEADSHOTS</span> <span className="font-normal">ANTHEM</span>
          </>
        }
        description="Building your modeling portfolio starts with stunning headshots that capture your unique look. I work with aspiring and professional models to create images that agencies want to see - from commercial and fashion to fitness and lifestyle. My studio right here in Anthem means you don't have to drive across the Valley for professional modeling photos."
        ctaText="GET PRICING"
        ctaLink="/pricing-individual"
        ...
        imageAlt="Modeling headshots Anthem Arizona"
        backgroundColor="#F1F1F1"
        textColor="dark"
        titleColor="blue"
        reverseColumns={true}
      ...
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">ON-LOCATION</span> <span className="font-normal">HEADSHOTS ANTHEM</span>
          </>
        }
        description="Prefer headshots at your location? I bring my professional studio setup directly to your Anthem home or office. This is perfect for busy professionals, corporate teams who need consistent headshots, or anyone who prefers the comfort of their own space. Same professional quality, maximum convenience for you."
        ctaText="GET QUOTE"
        ...
        imageAlt="On-location headshots Anthem Arizona"
        backgroundColor="#282725"
        textColor="white"
        titleColor="white"
        reverseColumns={false}
      ...
      <TwoColumnSection
        ...
        description="Whether you run a small, medium, or large business in Anthem, corporate headshots are integral to your success. I can come to your office and photograph your entire team with consistent lighting and backgrounds, or schedule your staff at my Anthem studio. Either way, you get professional results that elevate your company's image."
        ctaText="TEAM QUOTE"
        ctaLink="/corporate-staff-headshots"
        imageUrl="https://images.cmqheadshots.com/images/website%20media/jgp2-square-collage-3-2048x2048.webp"
        imageAlt="Corporate team headshots Anthem Arizona"
        backgroundColor="#F1F1F1"
        textColor="dark"
        titleColor="blue"
        reverseColumns={true}
      ...
      <FAQSection
        ...
        faqs={[
          ...
          {
            id: 2,
            question: "Do you offer on-location headshots in Anthem?",
            answer: "Yes! I can come to your Anthem home or business for headshot sessions. This is perfect for busy professionals, corporate teams who need consistent headshots, or anyone who prefers the comfort of their own space."
          },
          {
            id: 3,
          ...
          },
          {
            ...
            answer: "Yes! I offer on-location corporate photography where I bring my studio setup to your Anthem office. I can also schedule your team members at my studio for consistent, professional results that match your company branding."
          },
          {
            id: 5,
            question: "Why choose a local Anthem photographer?",
            answer: "As your neighbor, I'm invested in Anthem's community. You get convenience (no long drives), personalized service, and a photographer who understands local professionals. Plus, you're supporting a local small business!"
          }
        ]}
        showContactCTA={true}
      />
        ...
        <div className="container mx-auto px-4 w-full">
          <div className="text-center mb-16">
            <h2 className="font-raleway text-4xl lg:text-5xl mb-8">
              <span className="font-medium" style={{ color: 'white' }}>WHY ANTHEM CHOOSES</span>{' '}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card p-8 text-center hover:shadow-xl transition-shadow duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
              ...
              <p className="font-raleway text-xl font-normal" style={{
                ...
                Your local studio - no long drives to Phoenix or Scottsdale.
              </p>
            </div>
            <div className="card p-8 text-center hover:shadow-xl transition-shadow duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
              ...
              <p className="font-raleway text-xl font-normal" style={{
                ...
                I live here too - I&apos;m invested in our community&apos;s success.
              </p>
            </div>
            <div className="card p-8 text-center hover:shadow-xl transition-shadow duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
              ...
              <p className="font-raleway text-xl font-normal" style={{
                ...
                Professional quality from an experienced local photographer.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section bg-cmq-blue text-white" style={{ paddingTop: '120px', paddingBottom: '120px' }}>
        <div className="container mx-auto px-4 text-center">
          <p className="font-raleway text-3xl lg:text-4xl font-black mb-4 uppercase" style={{ fontWeight: '900', color: '#ffffff' }}>
            READY FOR YOUR ANTHEM HEADSHOTS?
          </p>
