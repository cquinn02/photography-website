...
export default function DemoCorporateFullV4() {
  const corporateFAQs = [
    {
      id: 1,
  ...
  return (
    <Layout
      title="DEMO V4 FULL — Corporate Split Hero | CMQ Headshots"
    ...
    >
      ...
      {/* Split Hero (DEMO) */}
      <SplitHeroDemo imageLeft={false} panelBg="dark-grey" centered={true} quoteHref="#request-quote" />
