...
// Every link opens the COMPLETE corporate page with that hero in place
const VERSIONS = [
  { href: '/demo-corporate-full-v2', label: 'V2 — white, image 2/3' },
  { href: '/demo-corporate-full-v4', label: 'V4 — dark linen, image 2/3' },
  { href: '/demo-corporate-full-v2b', label: 'V2B — white, 50/50 full-length' },
  { href: '/demo-corporate-full-v4b', label: 'V4B — dark linen, 50/50 full-length' }
]
    ...
    >
      <section className="bg-white py-16 px-6">
        <div className="mx-auto" style={{ maxWidth: `${DESKTOP_W * DESKTOP_SCALE * 3 + 96}px` }}>
          ...
          <p
            className="font-raleway text-lg mb-10 text-center"
            style={{ color: '#383838', letterSpacing: '0.03em', lineHeight: '1.6' }}
          >
            Click any version name to open the complete corporate page with that hero in place.
          </p>
