...
export default function HeadshotsChandler() {
  return (
    <Layout
      title="Professional Headshots Chandler AZ | CMQ Headshots"
      description="Professional headshot photographer serving Chandler AZ. Business, actor, modeling & corporate headshots. On-location at your home or office. Book today!"
      canonical="https://www.cmqheadshots.com/headshots-chandler"
      ogUrl="https://www.cmqheadshots.com/headshots-chandler"
    >
      ...
      <FAQSchema faqs={[
        { question: "What types of headshots do you offer in Chandler?", answer: "I offer a full range of headshot services: business and LinkedIn headshots, actor and theatrical headshots, modeling headshots, corporate team photography, and personal branding sessions. Whatever your professional needs, I can help." },
        { question: "Do you offer on-location headshots in Chandler?", answer: "Yes! I can come to your Chandler home or business for headshot sessions. This is perfect for busy professionals, corporate teams, or anyone who prefers the comfort of their own space." },
        ...
        { question: "Can you do corporate team headshots in Chandler?", answer: "Yes! I offer on-location corporate photography where I bring my studio setup to your Chandler office. Many of the tech companies and businesses along the Price Road corridor use my services. I can also schedule your team members at my studio for consistent, professional results." },
        { question: "How far is your studio from Chandler?", answer: "My studio in North Phoenix is about 35-45 minutes from Chandler, depending on your location. Many Chandler clients, especially those in the tech corridor, appreciate the professional studio environment, and I also offer on-location photography throughout the East Valley including Chandler." }
      ]} />
      ...
      <section className="relative w-full">
        <picture>
          ...
          <img
            ...
            alt="Professional Headshots Chandler Arizona"
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="font-raleway text-lg md:text-xl mb-6 leading-relaxed text-gray-700">
              Chandler is home to some of Arizona&apos;s most innovative companies and ambitious professionals. Whether you work in the Price Road tech corridor, downtown Chandler, or anywhere in between, professional headshots are essential for your career success. I create headshots that capture your professionalism and personality.
            </p>
      ...
      {/* Professional Headshots Chandler Section */}
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">CHANDLER HEADSHOT</span> <span className="font-normal">PHOTOGRAPHER</span>
          </>
        }
        description="As a professional headshot photographer serving Chandler and the East Valley, I work with professionals across the tech industry, healthcare, finance, and more. From Intel and PayPal employees to small business owners and entrepreneurs, I create headshots that help you stand out on LinkedIn, company websites, and professional profiles. My comfortable sessions make even camera-shy clients look their best."
        ctaText="GET PRICING"
        ...
        imageAlt="Professional headshots Chandler"
      ...
      {/* Chandler Business Headshots Section */}
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">BUSINESS HEADSHOTS</span> <span className="font-normal">CHANDLER</span>
          </>
        }
        description="Chandler's thriving tech corridor is home to major employers and innovative startups alike. Professional headshots are essential for your LinkedIn profile, company website, team pages, and investor presentations. I work with companies throughout Chandler, offering both in-studio sessions at my North Phoenix location and convenient on-location photography at your Chandler office."
        ...
        imageAlt="Business headshots Chandler Arizona"
      ...
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">ACTOR HEADSHOTS</span> <span className="font-normal">CHANDLER</span>
          </>
        }
        ...
        imageAlt="Actor headshots Chandler Arizona"
        backgroundColor="#282725"
        textColor="white"
        titleColor="white"
        reverseColumns={false}
      ...
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">MODELING HEADSHOTS</span> <span className="font-normal">CHANDLER</span>
          </>
        }
        ...
        imageAlt="Modeling headshots Chandler Arizona"
        backgroundColor="#F1F1F1"
        textColor="dark"
        titleColor="blue"
        reverseColumns={true}
      ...
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">ON-LOCATION</span> <span className="font-normal">HEADSHOTS CHANDLER</span>
          </>
        }
        description="Prefer headshots at your location? I bring my professional studio setup directly to your Chandler home or office. This is perfect for busy professionals, corporate teams who need consistent headshots, or anyone who prefers the comfort of their own space. Same professional quality, maximum convenience for you."
        ctaText="GET QUOTE"
        ...
        imageAlt="On-location headshots Chandler Arizona"
        backgroundColor="#282725"
        textColor="white"
        titleColor="white"
        reverseColumns={false}
      ...
      <FAQSection
        ...
        faqs={[
          ...
          {
            id: 2,
            question: "Do you offer on-location headshots in Chandler?",
            answer: "Yes! I can come to your Chandler home or business for headshot sessions. This is perfect for busy professionals, corporate teams who need consistent headshots, or anyone who prefers the comfort of their own space."
          },
          {
            id: 3,
          ...
          },
          {
            ...
            answer: "Yes! I offer on-location corporate photography where I bring my studio setup to your Chandler office. Many of the tech companies along the Price Road corridor use my services. I can also schedule your team members at my studio for consistent, professional results."
          },
          {
            id: 5,
            question: "How far is your studio from Chandler?",
            answer: "My studio in North Phoenix is about 35-45 minutes from Chandler, depending on your location. Many Chandler clients, especially those in the tech corridor, appreciate the professional studio environment, and I also offer on-location photography throughout the East Valley including Chandler."
          }
        ]}
        showContactCTA={true}
      />
        ...
        <div className="container mx-auto px-4 w-full">
          <div className="text-center mb-16">
            <h2 className="font-raleway text-4xl lg:text-5xl mb-8">
              <span className="font-medium" style={{ color: 'white' }}>WHY CHANDLER PROFESSIONALS CHOOSE</span>{' '}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card p-8 text-center hover:shadow-xl transition-shadow duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
              ...
              <p className="font-raleway text-xl font-normal" style={{
                ...
                Trusted by professionals throughout the Phoenix metro, including Chandler&apos;s tech community.
              </p>
            </div>
            <div className="card p-8 text-center hover:shadow-xl transition-shadow duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
            ...
            <div className="card p-8 text-center hover:shadow-xl transition-shadow duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
              ...
              <p className="font-raleway text-xl font-normal" style={{
                ...
                I can come to your Chandler office for convenient corporate headshots.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section bg-cmq-blue text-white" style={{ paddingTop: '120px', paddingBottom: '120px' }}>
        <div className="container mx-auto px-4 text-center">
          <p className="font-raleway text-3xl lg:text-4xl font-black mb-4 uppercase" style={{ fontWeight: '900', color: '#ffffff' }}>
            READY FOR YOUR CHANDLER HEADSHOTS?
          </p>
          <p className="font-raleway text-xl font-normal mb-8 text-white" style={{
            ...
            Let&apos;s create professional headshots that help you succeed in Chandler&apos;s competitive tech landscape.
          </p>
