...
export default function HeadshotsEastValley() {
  return (
    <Layout
      title="Professional Headshots East Valley AZ | CMQ Headshots"
      description="Professional headshot photographer serving the East Valley AZ. Business, actor, modeling & corporate headshots. On-location at your home or office. Book today!"
      canonical="https://www.cmqheadshots.com/headshots-east-valley"
      ogUrl="https://www.cmqheadshots.com/headshots-east-valley"
    >
      ...
      <FAQSchema faqs={[
        { question: "What types of headshots do you offer in the East Valley?", answer: "I offer a full range of headshot services: business and LinkedIn headshots, actor and theatrical headshots, modeling headshots, corporate team photography, and personal branding sessions. Whatever your professional needs, I can help." },
        { question: "Do you offer on-location headshots in the East Valley?", answer: "Yes! I can come to your East Valley home or business for headshot sessions. This is perfect for busy professionals, corporate teams, or anyone who prefers the comfort of their own space. I serve Tempe, Mesa, Gilbert, Chandler, Queen Creek, Apache Junction, and surrounding areas." },
        ...
        { question: "Can you do corporate team headshots in the East Valley?", answer: "Yes! I offer on-location corporate photography where I bring my studio setup to your East Valley office. I can also schedule your team members at my studio for consistent, professional results." },
        { question: "Where is your studio located?", answer: "My professional studio is in North Phoenix. Many East Valley clients appreciate the studio environment and make the 25-40 minute drive for their sessions. I also offer on-location photography throughout the East Valley for maximum convenience." }
      ]} />
      ...
      <section className="relative w-full">
        <picture>
          ...
          <img
            ...
            alt="Professional Headshots East Valley Arizona"
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="font-raleway text-lg md:text-xl mb-6 leading-relaxed text-gray-700">
              The East Valley is one of Arizona&apos;s most dynamic regions, home to thriving businesses in Tempe, Mesa, Gilbert, Chandler, and beyond. Whether you&apos;re a tech professional, healthcare worker, entrepreneur, or corporate executive, I create professional headshots that help you stand out and succeed in your career.
            </p>
      ...
      {/* Professional Headshots East Valley Section */}
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">EAST VALLEY</span> <span className="font-normal">HEADSHOT PHOTOGRAPHER</span>
          </>
        }
        description="I've been serving East Valley professionals for over 12 years, creating headshots for everyone from ASU faculty to tech executives, real estate agents to healthcare professionals. My comfortable approach helps even the most camera-shy clients relax and look their best. Whether you come to my North Phoenix studio or I travel to your East Valley location, you'll get stunning, professional results."
        ctaText="GET PRICING"
        ...
        imageAlt="Professional headshots East Valley"
      ...
      <section className="section" style={{ backgroundColor: '#F1F1F1', paddingTop: '60px', paddingBottom: '60px' }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="font-raleway text-3xl lg:text-4xl text-cmq-blue mb-4">
              <span className="font-bold">EAST VALLEY CITIES</span> <span className="font-light">WE SERVE</span>
            </h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-5xl mx-auto">
            {['Tempe', 'Mesa', 'Gilbert', 'Chandler', 'Queen Creek', 'Apache Junction'].map((city) => (
              <div key={city} className="bg-white p-4 rounded-lg border border-cmq-gray-light hover:border-cmq-blue transition-colors text-center">
                <MapPin className="h-8 w-8 text-cmq-blue mb-2 mx-auto" />
                <p className="font-raleway font-medium text-cmq-gray-dark">{city}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">BUSINESS HEADSHOTS</span> <span className="font-normal">EAST VALLEY</span>
          </>
        }
        description="The East Valley is home to major employers and innovative companies across tech, healthcare, aerospace, finance, and more. Professional headshots are essential for your LinkedIn profile, company website, team pages, and marketing materials. I serve clients throughout the region with both studio sessions and on-location photography."
        ...
        imageAlt="Business headshots East Valley Arizona"
      ...
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">ACTOR HEADSHOTS</span> <span className="font-normal">EAST VALLEY</span>
          </>
        }
        ...
        imageAlt="Actor headshots East Valley Arizona"
        backgroundColor="#282725"
        textColor="white"
        titleColor="white"
        reverseColumns={false}
      ...
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">MODELING HEADSHOTS</span> <span className="font-normal">EAST VALLEY</span>
          </>
        }
        ...
        imageAlt="Modeling headshots East Valley Arizona"
        backgroundColor="#F1F1F1"
        textColor="dark"
        titleColor="blue"
        reverseColumns={true}
      ...
      <TwoColumnSection
        title={
          <>
            <span className="font-bold">ON-LOCATION</span> <span className="font-normal">HEADSHOTS EAST VALLEY</span>
          </>
        }
        description="Prefer headshots at your location? I bring my professional studio setup directly to your East Valley home or office. This is perfect for busy professionals, corporate teams who need consistent headshots, or anyone who prefers the comfort of their own space. Same professional quality, maximum convenience for you."
        ctaText="GET QUOTE"
        ...
        imageAlt="On-location headshots East Valley Arizona"
        backgroundColor="#282725"
        textColor="white"
        titleColor="white"
        reverseColumns={false}
      ...
      <FAQSection
        ...
        faqs={[
          ...
          {
            id: 2,
            question: "Do you offer on-location headshots in the East Valley?",
            answer: "Yes! I can come to your East Valley home or business for headshot sessions. This is perfect for busy professionals, corporate teams who need consistent headshots, or anyone who prefers the comfort of their own space. I serve Tempe, Mesa, Gilbert, Chandler, Queen Creek, Apache Junction, and surrounding areas."
          },
          {
            id: 3,
          ...
          },
          {
            ...
            answer: "Yes! I offer on-location corporate photography where I bring my studio setup to your East Valley office. I can also schedule your team members at my studio for consistent, professional results that match your company branding."
          },
          {
            id: 5,
            question: "Where is your studio located?",
            answer: "My professional studio is in North Phoenix. Many East Valley clients appreciate the studio environment and make the 25-40 minute drive for their sessions. I also offer on-location photography throughout the East Valley for maximum convenience."
          }
        ]}
        showContactCTA={true}
      />
        ...
        <div className="container mx-auto px-4 w-full">
          <div className="text-center mb-16">
            <h2 className="font-raleway text-4xl lg:text-5xl mb-8">
              <span className="font-medium" style={{ color: 'white' }}>WHY EAST VALLEY PROFESSIONALS CHOOSE</span>{' '}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card p-8 text-center hover:shadow-xl transition-shadow duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
              ...
              <p className="font-raleway text-xl font-normal" style={{
                ...
                Trusted by professionals throughout the Phoenix metro and East Valley for over a decade.
              </p>
            </div>
            <div className="card p-8 text-center hover:shadow-xl transition-shadow duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
            ...
            <div className="card p-8 text-center hover:shadow-xl transition-shadow duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
              ...
              <p className="font-raleway text-xl font-normal" style={{
                ...
                I travel throughout the East Valley for convenient corporate headshots at your location.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section bg-cmq-blue text-white" style={{ paddingTop: '120px', paddingBottom: '120px' }}>
        <div className="container mx-auto px-4 text-center">
          <p className="font-raleway text-3xl lg:text-4xl font-black mb-4 uppercase" style={{ fontWeight: '900', color: '#ffffff' }}>
            READY FOR YOUR EAST VALLEY HEADSHOTS?
          </p>
          <p className="font-raleway text-xl font-normal mb-8 text-white" style={{
            ...
            Let&apos;s create professional headshots that help you succeed throughout the East Valley.
          </p>
