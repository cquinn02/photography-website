...
export default function LawyerHeadshots2() {
  ...
  return (
    <>
      ...
      {/* Attorney Headshots Phoenix, AZ — TwoColumnSection */}
      <TwoColumnSection
        title={<><span className="font-medium">ATTORNEY HEADSHOTS</span> <span className="font-normal">PHOENIX, AZ</span></>}
        description="Attorney headshots in Phoenix, AZ are often the first impression a potential client has of you. Profiles with professional photos outperform outdated or smartphone shots on Avvo, FindLaw, and firm websites. I photograph solo practitioners and entire firms so every headshot matches."
        imageUrl="https://images.cmqheadshots.com/images/cls-law-6636r-optimized.webp"
        imageAlt="Attorney headshots Phoenix, AZ - professional attorney portrait by CMQ Headshots"
        imageWidth={1000}
        imageHeight={1000}
