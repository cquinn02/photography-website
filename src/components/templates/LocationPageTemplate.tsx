  ...
  return (
    ...
    >
      ...
      <FAQSchema faqs={[
        ...
        { question: `Can you come to our office in ${location} and take our staff headshots?`, answer: `Yes, I can! I can come out to your ${location} office and photograph your staff and C-suite employees, resulting in less downtime for your staff and ensuring consistency on your website.` },
