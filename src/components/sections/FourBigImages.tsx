...
export default function FourBigImages({
  images,
  title,
  subtitle,
  ...
  if (!images || !Array.isArray(images)) {
    console.warn('FourBigImages: images prop is required and must be an array')
    return null
  }

  // Show up to 4 images
  if (images.length < 4) {
    console.warn('FourBigImages: At least 4 images recommended for best display')
  }
